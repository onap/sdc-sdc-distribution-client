...
public class SdcConnectorClient {
    ...
    public Either<List<String>, IDistributionClientResult> getValidArtifactTypesList() {
        Pair<HttpSdcResponse, CloseableHttpResponse> getServersResponsePair = performSdcServerRequest();
    ...
    private Pair<HttpSdcResponse, CloseableHttpResponse> performSdcServerRequest() {
        String requestId = generateRequestId();
        Map<String, String> requestHeaders = addHeadersToHttpRequest(requestId);
        log.debug("about to perform getServerList. requestId= {} url= {}", requestId, SdcUrls.GET_VALID_ARTIFACT_TYPES);
        return httpClient.getRequest(SdcUrls.GET_VALID_ARTIFACT_TYPES, requestHeaders, false);
    }
