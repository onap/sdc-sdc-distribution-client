...
public class SdcConnectorClient {
    ...
    public Either<List<String>, IDistributionClientResult> getKafkaDistData() {
    ...
    private Either<List<String>, IDistributionClientResult> parseGetKafkaDistDataResponse(HttpSdcResponse getKafkaDistDataResponse) {
        Either<List<String>, IDistributionClientResult> result;
        try {
            ...
            Gson gson = new GsonBuilder().create();
            List<String> kafkaDataList = gson.fromJson(jsonMessage, listType);
            result = Either.left(kafkaDataList);
