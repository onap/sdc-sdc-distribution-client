...
public class NotificationSenderTest {
    ...
    private final Either<CambriaBatchingPublisher, IDistributionClientResult> cambriaPublisher = Either.left(publisher);
    private final List<String> emptyServers = Collections.emptyList();
    private final NotificationSender validNotificationSender = new NotificationSender(cambriaPublisher, emptyServers);;
    ...
    public void whenPublisherIsValidShouldReturnSuccessStatus() throws IOException, InterruptedException {
        ...
        //when
        IDistributionClientResult result = validNotificationSender.send(status);
