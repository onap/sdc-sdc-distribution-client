 ...
 class ClientInitializerTest {
     ...
     @Container
     public GenericContainer mock_dmaap = new GenericContainer("registry.gitlab.com/orange-opensource/lfn/onap/mock_servers/mock-dmaap:latest")
             .withNetworkMode("host");

     @Container
     public GenericContainer mock_sdc = new GenericContainer("registry.gitlab.com/orange-opensource/lfn/onap/mock_servers/mock-sdc:latest")
             .dependsOn(mock_dmaap)
             .withNetworkMode("host");
     @Mock
     Logger log;
