...
public class DistributionClientConfig implements IConfiguration {
    ...
    public DistributionClientConfig() {
        this.asdcAddress = "localhost:30206";
        this.comsumerID = "dcae-openapi-manager";
        this.consumerGroup = "noapp";
        this.environmentName = "AUTO";
        ...
        this.useHttpsWithSDC = false;
        msgBusAddress = new ArrayList<>();
        msgBusAddress.add("message-router.onap");
        msgBusAddress.add("message-router.onap");
        msgBusAddress.add("message-router.onap");
    }
