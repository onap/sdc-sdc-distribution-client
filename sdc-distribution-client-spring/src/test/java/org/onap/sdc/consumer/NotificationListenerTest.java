...
@SpringBootTest(
  classes = {
    NotificationListener.class, TestNotificationCallback.class, DistributionClientAutoConfiguration.class, NotificationPublisher.class
  })
...
public class NotificationListenerTest extends IntegrationTest {
  ...
  void thatArtifactsAreParsed() {
    ...
    String notification = Files.readString(Paths.get(distributionJson));
