...
public class StatusListener {
  ...
  @KafkaListener(topics = "${distribution-client.kafka.topics.status}",
                 containerFactory = "distributionClientKafkaListenerContainerFactory")
  public void statusListener(String message) {
    IStatusData statusData = gson.fromJson(message, StatusDataImpl.class);
